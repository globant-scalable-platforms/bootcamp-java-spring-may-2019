...
public abstract class BaseClass {
	...
	@Before public void setup() {
		...
		Mockito.when(customerService.findCustomerById(1))
				.thenReturn(new Customer(1, "Mike", "Castro"));

		Customer custom = new Customer(4, "Diego", "Alvarez");
		
		Mockito.when(customerService.newCostumer(any(Customer.class)))
				.thenReturn(new Customer(4, "Diego", "Alvarez"));
	}
