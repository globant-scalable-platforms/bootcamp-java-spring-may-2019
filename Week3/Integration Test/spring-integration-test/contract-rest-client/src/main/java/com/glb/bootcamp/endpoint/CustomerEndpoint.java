...
public class CustomerEndpoint {
    ...
    public String newCostumer(@RequestBody Customer customer) {
        Customer customerResponse =
                this.restTemplate.postForObject("http://localhost:8000/customer", customer, Customer.class);
        return "Welcome " + customerResponse.getName();
    }
