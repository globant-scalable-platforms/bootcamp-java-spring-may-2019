package DavidAcunaW1.bootcamp.java.spring.may;
...
public class TransferringImpTest{
    ...
    public void setUp() throws Exception {
        ...
        username = "David";
        Account saving = new Account(username, 1500, AccountType.SAVING);
        Account current = new Account(username, 3000, AccountType.CURRENT);
        ...
        when(accountRepository.updateAccount(current))
        	.thenReturn(current);
        when(accountRepository.updateAccount(saving))
        	.thenReturn(saving);
    }

    @Test
    public void shouldPass() throws AccountException {
    	TransferResponse response = transferring.transferMoney(accountRepository.findAccountByUsernameAndAccountType("David", AccountType.CURRENT), accountRepository.findAccountByUsernameAndAccountType("David", AccountType.SAVING), 2500);
