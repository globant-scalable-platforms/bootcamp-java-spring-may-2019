...
public class AccountServiceImpl implements AccountService {
    ...
    public boolean checkCapacity(final String usernameCurrent, final String usernameSaving){
        final Account accountCurrent = accountRepository.findAccountByUsernameAndType(usernameCurrent, AccountType.CURRENT);
        final Account accountSaving = accountRepository.findAccountByUsernameAndType(usernameSaving, AccountType.SAVING);
        return accountCurrent.getBalance()>0 && accountSaving.getBalance()>0;
    }
